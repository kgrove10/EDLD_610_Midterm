...
```{r}
by_school_grade_year <- split(school_data, paste(school_data$school, school_data$grade_level, school_data$academic_year)) 


gaps <- map_dbl(by_school_grade_year, ~gap(.x, "white", "hispanic_latino")) 
